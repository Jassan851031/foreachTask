                  ...
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form-g roup">
                        <label className="form-label">Direccion Punto de Partida</label>
                        <input type="text" id="no_card" className="form-control" placeholder="xxxx-xxxx-xxxx" />
                      </div>
                    </div>
                    ...
                    <div className="col-md-4">
                      <div className="form-group">
                        ...
                        <input type="text" id="total" className="form-control" placeholder="Insert Amount" />
                      </div>
                    </div>
                  </div>
                  <div className="row">
